...
def undistort_img():
    ...
    images = glob.glob('/home/tgaddam/catkin_ws/src/lane_detection/nodes/camera_cal/*.jpg')
    # img = None
    ...
    pickle.dump( dist_pickle, open('/home/tgaddam/catkin_ws/src/lane_detection/nodes/camera_cal/cal_pickle.p', 'wb') )

def undistort(img, cal_dir='/home/tgaddam/catkin_ws/src/lane_detection/nodes/camera_cal/cal_pickle.p'):
...
def vid_pipeline_stripped(img, scale_fac=250):
    global running_avg
    global index
    ...
    img_ = perspective_warp(img_)
    out_img, curves, lanes, ploty = sliding_window(img_, draw_windows=False)
    # print(len(curves[0]), len(curves[1]))
    # print(img_.shape)
    curverad = get_curve(img, curves[0], curves[1])
    lane_curve = np.mean([curverad[0], curverad[1]])
...
if __name__ == '__main__':
    ...
    img = cv2.imread('/home/tgaddam/catkin_ws/src/lane_detection/nodes/camera_cal/calibration1.jpg')
    dst = undistort(img)
